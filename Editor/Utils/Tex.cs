...
namespace SaintsHierarchy.Editor.Utils
{
    ...
    {
        private static Texture2D ApplyTextureColor(Texture2D texture, Color newColor)
        {
        ...
        private static void ResizeTexture(Texture2D originalTexture, int newWidth, int newHeight)
        {
        ...
        private static void ResizeHeightTexture(Texture2D originalTexture, int newHeight)
        {
        ...
        private static void ResizeWidthTexture(Texture2D originalTexture, int newWidth)
        {
            int oriWidth = originalTexture.width;
            int oriHeight = originalTexture.height;
